    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          <RefreshCw className="h-8 w-8 animate-spin mx-auto mb-4" style={{ color: "#ffcb74" }} />
    ...
    return (
      <div className="min-h-screen bg-black" style={{ color: "#f6f6f6" }}>
        ...
        <main className="flex-1 flex items-center justify-center px-6">
          <Card className="w-full max-w-md border backdrop-blur-sm shadow-2xl"
                style={{
                  borderColor: "rgba(255, 203, 116, 0.2)",
                  backgroundColor: "rgba(255, 255, 255, 0.05)",
                }}>
            <CardHeader className="text-center">
              <AlertCircle className="h-12 w-12 mx-auto mb-4" style={{ color: "#ffcb74" }} />
              <CardTitle style={{ color: "#f6f6f6" }}>Authentication Required</CardTitle>
      ...
      <div className="min-h-screen bg-black" style={{ color: "#f6f6f6" }}>
        ...
        <main className="flex-1 flex items-center justify-center px-6">
          <Card className="w-full max-w-md border backdrop-blur-sm shadow-2xl"
            ...
            <CardHeader className="text-center">
              <User className="h-12 w-12 mx-auto mb-4" style={{ color: "#ffcb74" }} />
              <CardTitle style={{ color: "#f6f6f6" }}>Join the Community</CardTitle>
              <CardDescription style={{ color: "#d1d1d1" }}>
  ...
  return (
    <div className="min-h-screen bg-black" style={{ color: "#f6f6f6" }}>
      ...
      <main className="flex-1 flex flex-col max-w-4xl mx-auto p-6">
        ...
        {/* Messages Container */}
        <Card className="flex-1 flex flex-col border backdrop-blur-sm"
              style={{
                borderColor: "rgba(255, 203, 116, 0.2)",
          ...
          <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <MessageCircle className="h-5 w-5" style={{ color: "#ffcb74" }} />
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center space-x-2 mb-1">
                        ...
                        {message.user.verificationStatus === 'verified' && (
                          <Badge variant="secondary" className="bg-green-900/20 text-green-400 border-green-400/20 text-xs">
