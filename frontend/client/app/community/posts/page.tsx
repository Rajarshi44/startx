...
import { Heart, MessageCircle, Share2, Plus, ImageIcon, Video, Upload, X, Filter, Users, TrendingUp, Clock, Hash, ArrowLeft, Sparkles } from 'lucide-react'
...
export default function CommunityPostsPage() {
  ...
  const addTag = () => {
    if (newTag.trim() && !newPost.tags.includes(newTag.trim().toLowerCase()) && newPost.tags.length < 10) {
      setNewPost(prev => ({
        ...prev,
    ...
    return (
      <div className="min-h-screen bg-black text-white overflow-hidden relative">
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6">
          <div className="border backdrop-blur-md shadow-2xl rounded-3xl p-12 max-w-md w-full text-center"
               style={{
                 borderColor: "rgba(255, 203, 116, 0.2)",
                 backgroundColor: "rgba(255, 255, 255, 0.05)",
               }}>
            <div className="mb-8">
              <div className="w-20 h-20 mx-auto mb-6 rounded-full border-2 flex items-center justify-center"
                   style={{ borderColor: "#ffcb74", backgroundColor: "rgba(255, 203, 116, 0.1)" }}>
                <Users className="h-10 w-10" style={{ color: "#ffcb74" }} />
              </div>
              <h2 className="text-3xl font-bold mb-4 text-white">Community Posts</h2>
              <p className="text-gray-300 leading-relaxed">
                Connect with founders, investors, and innovators. Share insights and discover opportunities in our startup ecosystem.
              </p>
            </div>
      ...
      <div className="relative z-10 min-h-screen">
        ...
        <div className="px-6 pb-6">
          <div className="max-w-7xl mx-auto">
            <div className="border backdrop-blur-md shadow-2xl rounded-3xl p-8"
                 style={{
                   borderColor: "rgba(255, 203, 116, 0.2)",
                   backgroundColor: "rgba(255, 255, 255, 0.05)",
                 }}>
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">Share insights and connect with the ecosystem</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Dialog open={showCreatePost} onOpenChange={setShowCreatePost}>
                    ...
                    <DialogContent className="border backdrop-blur-md shadow-2xl rounded-3xl max-w-2xl max-h-[90vh] overflow-y-auto"
                                   style={{
                                     borderColor: "rgba(255, 203, 116, 0.2)",
                      ...
                      <div className="space-y-6 p-2">
                        ...
                        <div className="border-2 rounded-xl p-4"
                          ...
                          <div className="flex items-center gap-2 mb-3">
                            <Hash className="h-5 w-5" style={{ color: "#ffcb74" }} />
                            <Input
                            ...
                            <Button 
                              onClick={addTag} 
                              size="sm" 
                              disabled={!newTag.trim() || newPost.tags.length >= 10}
                        ...
                        <div className="border-2 rounded-xl p-4"
                          ...
                          <div className="flex items-center gap-2 mb-4">
                            <Upload className="h-5 w-5" style={{ color: "#ffcb74" }} />
                            <label className="text-lg font-medium" style={{ color: "#ffcb74" }}>
                              Media (Max 5 files)
                            </label>
                          </div>
                          ...
                          <input
                            ...
                            disabled={uploadingMedia || newPost.media.length >= 5}
                          />
                            ...
                            <div className="grid grid-cols-2 gap-3 mt-4">
                              {newPost.media.map((media, index) => (
                                <div key={index} className="relative group">
                                  {media.type === 'image' ? (
                                    <div className="relative w-full h-24 rounded-xl overflow-hidden border-2"
                                         style={{ borderColor: "rgba(255, 203, 116, 0.3)" }}>
                                      <NextImage
                                        src={media.url}
                                        alt={`Upload ${index + 1}`}
                                    ...
                                    <div className="w-full h-24 rounded-xl border-2 flex items-center justify-center"
                                         style={{ 
                                           borderColor: "rgba(255, 203, 116, 0.3)",
                                           backgroundColor: "rgba(255, 203, 116, 0.1)"
                                         }}>
                                      <Video className="h-8 w-8" style={{ color: "#ffcb74" }} />
                                    </div>
                                  )}
                                  <button
                        ...
                        <div className="flex justify-end gap-3 pt-4">
                          ...
                          <Button 
                            ...
                            disabled={!newPost.title.trim() || !newPost.content.trim() || uploadingMedia}
              ...
              <div className="flex items-center gap-4 mt-6 pt-6 border-t"
                ...
                <Select value={filters.sortBy} onValueChange={(value: any) => setFilters(prev => ({ ...prev, sortBy: value }))}>
                  <SelectTrigger className="w-48 bg-black/20 border-2 text-white rounded-xl"
                                 style={{ borderColor: "rgba(255, 203, 116, 0.3)" }}>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent className="bg-black border-2 rounded-xl"
                                 style={{ borderColor: "rgba(255, 203, 116, 0.3)" }}>
                    <SelectItem value="latest" className="text-white hover:bg-[#ffcb74]/10 rounded-lg">
                      <div className="flex items-center gap-2">
                        <Clock className="h-4 w-4" />
                        Latest Posts
                      </div>
                    </SelectItem>
                    <SelectItem value="popular" className="text-white hover:bg-[#ffcb74]/10 rounded-lg">
                      <div className="flex items-center gap-2">
                        <Heart className="h-4 w-4" />
                        Most Popular
                      </div>
                    </SelectItem>
                    <SelectItem value="trending" className="text-white hover:bg-[#ffcb74]/10 rounded-lg">
                      <div className="flex items-center gap-2">
          ...
          <div className="max-w-7xl mx-auto">
            {loading ? (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="border backdrop-blur-md shadow-2xl rounded-3xl p-8 animate-pulse"
                       style={{
                         borderColor: "rgba(255, 203, 116, 0.2)",
                         backgroundColor: "rgba(255, 255, 255, 0.05)",
                       }}>
              ...
              <div className="border backdrop-blur-md shadow-2xl rounded-3xl p-16 text-center"
                   style={{
                     borderColor: "rgba(255, 203, 116, 0.2)",
                     backgroundColor: "rgba(255, 255, 255, 0.05)",
                   }}>
                <div className="w-24 h-24 mx-auto mb-8 rounded-full border-2 flex items-center justify-center"
                     style={{ borderColor: "#ffcb74", backgroundColor: "rgba(255, 203, 116, 0.1)" }}>
                  <Users className="h-12 w-12" style={{ color: "#ffcb74" }} />
                </div>
                <h3 className="text-2xl font-bold text-white mb-4">No posts yet</h3>
                <p className="text-gray-300 mb-8 text-lg">Be the first to share something with the community!</p>
                <Button 
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                  {posts.map((post, index) => (
                    <div key={post._id} 
                      ...
                      {/* Post Header */}
                      <div className="flex items-center gap-4 mb-6">
                        <Avatar className="h-12 w-12 border-2" style={{ borderColor: "#ffcb74" }}>
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="font-bold text-white text-lg">{post.user.username}</span>
                        ...
                        <div className="mb-6">
                          <div className="grid grid-cols-1 gap-3">
                            {post.media.map((media, index) => (
                              <div key={index} className="relative rounded-2xl overflow-hidden border-2"
                                   style={{ borderColor: "rgba(255, 203, 116, 0.3)" }}>
                                {media.type === 'image' ? (
                                  <NextImage
                                    src={media.url}
                      ...
                      <Separator className="mb-6" style={{ backgroundColor: "rgba(255, 203, 116, 0.2)" }} />
