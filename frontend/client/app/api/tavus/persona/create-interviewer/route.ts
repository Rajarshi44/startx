...
export async function POST() {
  try {
    ...
    const persona = await tavusClient.createPersona(personaConfig)
    ...
    console.error("Error creating AI interviewer persona:", error)
    return NextResponse.json(
      {
        error: "Failed to create AI interviewer persona",
